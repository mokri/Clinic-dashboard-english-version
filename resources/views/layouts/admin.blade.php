...
<body>
    <div class="main-wrapper">
        <div class="header">
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo">
					<img src=" {{asset('img/logo.png')}}" width="60" height="70" alt=""><span>ClinicDashboard</span>
				</a>
			</div>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="{{ Request::is('appointments','appointments/add-appointments') ? 'active' : 'no' }}">
                            <a href="{{route('appointments')}}"><i class="fa fa-calendar"></i> <span>Appointment</span></a>
                        </li>
                ...
                <div class="copyright">
                    <div class="cr">
                        <p>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="https://abdelhakmokri.pythonanywhere.com/" target="_blank">ABDELHEQ MOKRI</a> </p>
 ...
 <script src="{{ asset('js/fullcalendar.js') }}"></script>
    ...
    <script>
        $("#names").select2( {
            placeholder: "First-name - Last-name - birth date",
            allowClear: true
        } );
    </script>

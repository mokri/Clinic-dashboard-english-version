...
<div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3>{{ $profNumber }}</h3>
                                <span class="widget-title4">Teachers <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">upcoming appointments</h4> <a href="{{ route('appointments') }}" class="btn btn-primary float-right">View all</a>
							</div>
									...
									<table class="table mb-0">
                                        ...
                                        @foreach($appointments as $appointment)
											<tr>
												...
												<td class="text-right">
													<a href="{{ route('patient.show',["id" => $appointment->patientID]) }}" class="btn btn-outline-primary take-btn">Take</a>
												</td>
											</tr>
                                            @endforeach
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
							<div class="card-header bg-white">
								<h4 class="card-title mb-0">My Patients (teachers)</h4>
							</div>
                            <div class="card-body">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            ...
                                            <div class="contact-info">
                                                ...
                                                <span class="contact-date">{{$pp->birthdate}}, professor </span>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="{{ route('patients')  }}" class="text-muted">See all patients</a>
                            </div>
                        </div>
                    </div>
				</div>
				<div class="row">
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Patients with chronic diseases</h4>
							</div>
										...
										@foreach($patientsWithChronic as $pc)
											...
											<tr>
												...
												<td>
                                                    ...
                                                    <h5 class="time-title p-0"> Date of birth </h5>
                                                    <p> {{ $pc->birthdate }}</p>
                                             ...
                                             <td>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{ route('patient.show',["id" => $pc->patientID]) }}" class="btn btn-outline-primary take-btn">Take</a>
                                                </td>
											</tr>

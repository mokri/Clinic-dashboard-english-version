...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-sm-5 col-6 text-right m-b-30">
            <a href="{{ route('patient.edit',['id'=>$patient->id]) }}" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit</a>
        </div>
    </div>
                            ...
                            <div class="col-md-7">
                                <ul class="personal-info">
                                    ...
                                    <li>
                                        ...
                                        <span class="text">{{ $patient->poid }}</span>
                                    </li>

                                    <li>
                                        <span class="title">Height:</span>
                                        <span class="text">{{ $patient->taille }}</span>
                                    </li>
    ...
    <div class="profile-tabs">
        ...
        <ul class="nav nav-tabs nav-tabs-bottom">
            ...
            <li class="nav-item"><a class="nav-link" href="#bottom-tab2" data-toggle="tab">Treatment</a></li>
            <li class="nav-item"><a class="nav-link" href="#bottom-tab3" data-toggle="tab">Antecedents</a></li>

            <input type="submit" value="Save" class="btn float-right btn-primary ">
        </ul>
        ...
        <div class="tab-content">
                            ...
                            <div class="experience-box">
                                <ul class="experience-list">
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="materialChecked2">Have a Chronic Disease ?</label>

                                                @if($diagnosis)
                                                <input class="form-control bg-warning" name="chronic" type="text" value="{{$patient->chronic}}">
                                                    @else
                                                    <input class="form-control bg-warning" name="chronic" type="text" >
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Notes/Comments</a>
                                                <div class="form-group">
            ...
            <div class="tab-pane" id="bottom-tab3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h3 class="card-title">Antécédent</h3>
                            <div class="experience-box">
                                <ul class="experience-list">
                                    <li>
                                        <div class="experience-user">
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="3" cols="30" name="antecedent">@if($diagnosis){{$patient->antecedent}}@endif</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
